 ...
 * Verifica que a exceção carrega corretamente o campo violado e o valor
 * duplicado, e que a mensagem de erro exibida ao usuário é a esperada.
 */
...
public class CadastroDuplicadoExceptionTest {
    ...
    class DuplicidadePorMatricula {
        ...
        void deveTerCampoMatricula() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.MATRICULA, "A0001");
        ...
        void deveTerValorMatriculaDuplicada() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.MATRICULA, "P0042");
        ...
        void deveTerMensagemCorretaParaMatricula() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.MATRICULA, "C0001");
        ...
        void devePreservarMatriculaComPrefixoAD() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.MATRICULA, "AD0001");
    ...
    class DuplicidadePorEmail {
        ...
        void deveTerCampoEmail() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, "joao@teste.com");
        ...
        void deveTerValorEmailDuplicado() {
            ...
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, emailDuplicado);
        ...
        void deveTerMensagemCorretaParaEmail() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, "dup@teste.com");
        ...
        void devePreservarEmailComCasingOriginal() {
            ...
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, emailMisto);
    ...
    class DistincaoEntreCampos {
        ...
        void mensagensDevemSerDistintas() {
            CadastroDuplicadoException exMatricula =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.MATRICULA, "A0001");
            CadastroDuplicadoException exEmail =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, "a@b.com");
        ...
        void getValorDuplicadoNaoDeveSerNullQuandoFornecido() {
            CadastroDuplicadoException ex =
                    new CadastroDuplicadoException(CadastroDuplicadoException.Campo.EMAIL, "test@test.com");
