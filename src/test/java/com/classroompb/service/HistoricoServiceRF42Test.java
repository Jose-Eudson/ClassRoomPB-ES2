...
public class HistoricoServiceRF42Test {
    ...
    class ListarReprovados {
        ...
        void naoDeveConsiderarRecuperacaoComoReprovacao() throws Exception {
            historicoRepository.atualizar(new Historico("A001", "2026.1", "MAT001", "Matematica", "T01", "P001",
                    "Prof X", 5.0, 90.0, "RECUPERACAO"));
            historicoRepository.atualizar(new Historico("A002", "2026.1", "MAT001", "Matematica", "T01", "P001",
                    "Prof X", 3.0, 90.0, "REPROVADO POR NOTA"));
