 ...
 *
 * Usa anotações do Jackson para serialização/deserialização polimórfica em JSON: o campo "tipo" determina qual
 * subclasse concreta instanciar ao carregar do arquivo.
 */

@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "tipo", visible = true)
@JsonSubTypes({ @JsonSubTypes.Type(value = Aluno.class, name = "ALUNO"),
